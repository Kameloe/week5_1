...
# # # # artist = "Beyonce" 
# this is the example. Try yours in the next line:
artist = "Ahmed Amin"
...
message4 = f"This playlist has {songcount} songs."
print(message4)
...
# # # I .pop'd and .remove'd most of my songs, so "Break My Soul" is the only one left.

playlist.join("Yay Area" + "Hrs and Hrs" + "Purple Hearts" + "Moscow Mule")
print(playlist)